            ...
            async with ManagedPage(browser, keyword) as page:
                ...
                try:
                    ...
                    if "ERR_PROXY_CONNECTION_FAILED" in error_msg:
                        ...
                        special_logger.info(f"[work-{params.worker_id}][{params.task_id}][{keyword}] ERR_PROXY_CONNECTION_FAILED")
                    ...
                    # ✅ 其他网络错误
                        ...
                        special_logger.info(f"[work-{params.worker_id}][{params.task_id}][{keyword}] ERR_TUNNEL_CONNECTION_FAILED")
                        await params.app.set_fail(params.atm, params.proxies)
                        return None
                    ...
                    # ✅ 超时错误
                        ...
                        special_logger.info(f"[work-{params.worker_id}][{params.task_id}][{keyword}] TIME_OUT")
                ...
                if '/sorry/' in current_url or 'sorry' in current_url:
                    special_logger.info(f"[work-{params.worker_id}][{params.task_id}][{keyword}] {params.proxies['server']} Verification code")
